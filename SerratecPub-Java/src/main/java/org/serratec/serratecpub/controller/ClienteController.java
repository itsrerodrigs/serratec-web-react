...
public class ClienteController {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Cliente localizado!"),
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Cliente excluído!"),
			@ApiResponse(responseCode = "401", description = "Erro de autenticação"),
			@ApiResponse(responseCode = "403", description = "Não há permissão para acessar o recurso!"),
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Cliente alterado!"),
			@ApiResponse(responseCode = "401", description = "Erro de autenticação"),
			@ApiResponse(responseCode = "403", description = "Não há permissão para acessar o recurso!"),
			@ApiResponse(responseCode = "404", description = "Caso a lista esteja vazia, é porque não existe cliente com esse id. Verifique!"), })
	...
	@GetMapping("/login/{log}/{senha}")
	public ResponseEntity<?> login(@PathVariable String log, @PathVariable String senha) {
	    Optional<ClienteDto> cliente = clienteService.verificarLogin(log, senha);
