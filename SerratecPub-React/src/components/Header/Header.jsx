  ...
  return (
    <>
      <header className="flex justify-between items-center text-white py-6 px-8 md:px-32 bg-neutral-900 drop-shadow-md">
        ...
        ></i>
        <div
          className={`absolute xl:hidden top-24 left-0 w-full bg-neutral-900 flex-col items-center gap-6 font-semibold text-lg transform transition-transform ${isMenuOpen ? "opacity-100" : "opacity-0"
            }`}
